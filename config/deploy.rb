...
set :repository,  "myshop@git.youserver.domain:/home/repo/myshop.git"
...
role :web, "s1.youserver.domain"                          # Your HTTP server, Apache/etc
role :app, "s1.youserver.domain"                          # This may be the same as your `Web` server
role :db,  "s1.youserver.domain", :primary => true # This is where Rails migrations will run
